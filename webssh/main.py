...
from webssh.handler import IndexHandler, WsockHandler, NotFoundHandler , TelnetHandler , TnWsockHandler
...
def make_handlers(loop, options):
    ...
    handlers = [
        ...
        (r'/webtelnet', TelnetHandler, dict(loop=loop)),
        (r'/webtelnet/ws', TnWsockHandler, dict(loop=loop)),
